...
public class SecretMessageBox {
	...
	// 1. Set a password in a String variable
		String password = "youaredumb";
	// 2. Using a pop-up, ask the first person for a secret message and store it in a variable
		String say = JOptionPane.showInputDialog("Write a secrete message");
	// 3. Now use a pop-up to tell the NEXT user that they can only see the secret message 
	//    if they can guess the passcode
		String ask = JOptionPane.showInputDialog("Write a passcode in order to see the secrete message"); 		
	// 4. If their guess matches the password, show them the secret message
		if (ask.equals(password)) { 
